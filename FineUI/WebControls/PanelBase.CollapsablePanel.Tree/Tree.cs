...
namespace FineUI
{
    ...
    public class Tree : CollapsablePanel, IPostBackDataHandler, IPostBackEventHandler
    {
        ...
        */
        ...
        {
            if (EnableMultiSelect)
                return String.Format("{0}.getSelectionModel().getSelectedNodes().length>0", ScriptID);
            else
                return String.Format("{0}.getSelectionModel().getSelectedNode()!=null", ScriptID);
        }
