...
namespace FineUI
{
    ...
    public class Grid : CollapsablePanel, IPostBackDataHandler, IPostBackEventHandler
    {
            ...
            get
            {
                ...
                if (obj == null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            GridColumn column = FindColumn(SortColumn);
                            if (column != null)
        ...
        protected override void OnFirstPreRender()
        {
            ...
            OB.AddProperty("enableHdMenu", true);
            ...
            OB.AddProperty("enableColumnMove", true);
        ...
        private string GetGridColumnScript()
        {
            ...
            foreach (GridColumn column in AllColumns)
            {
                ...
                else
                {
                    ...
                    #region  fengshengde扩展
                    if (column.Sortable)
                    {
                        columnBuilder.AddProperty("sortable", true);
                    }
                    columnBuilder.AddProperty("hideable", column.Hideable);
                    #endregion
