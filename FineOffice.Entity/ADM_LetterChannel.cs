...
{
    [Table(Name = "dbo.ADM_LetterChannel")]
    public partial class ADM_LetterChannel : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Association(Name = "FK_ADM_Letter_ADM_LetterChannel", Storage = "_ADM_Letter", OtherKey = "ChannelID", DeleteRule = "NO ACTION")]
        ...
        {
            this.SendPropertyChanging();
            entity.ADM_LetterChannel = this;
        }

        private void detach_ADM_Letter(ADM_Letter entity)
        {
            this.SendPropertyChanging();
            entity.ADM_LetterChannel = null;
        }
    }
}
