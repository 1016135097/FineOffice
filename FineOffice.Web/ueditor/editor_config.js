...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        , imagePath: window.DEFINITION_URL           //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"upfile"                   //图片数据的key,若此处编辑，需要在后台对应文件编辑对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        //,maxImageSideLength:900                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中

        //涂鸦图片配置区
        , scrawlUrl: URL + "net/scrawlUp.ashx"       //涂鸦上传地址
        , scrawlPath: window.DEFINITION_URL          //图片修正地址，同imagePath

        //附件上传配置区
        , fileUrl: URL + "net/fileUp.ashx"           //附件上传提交地址
        , filePath: window.DEFINITION_URL            //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处编辑，需要在后台对应文件编辑对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        , catcherUrl: URL + "net/getRemoteImage.ashx"//处理远程图片抓取的地址
        , catcherPath: window.DEFINITION_URL         //图片修正地址，同imagePath
        //,catchFieldName:"upfile"                   //提交到后台远程图片uri合集，若此处编辑，需要在后台对应文件编辑对应参数
        //,separater:'ue_separate_ue'                //提交至后台的远程图片地址字符串分隔符
        //,localDomain:[]                            //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地,默认不抓取127.0.0.1和localhost

        //图片在线管理配置区
        , imageManagerUrl: URL + "net/imageManager.ashx"       //图片在线管理的处理地址
        , imageManagerPath: window.DEFINITION_URL              //图片修正地址，同imagePath


        //word转存配置区
        , wordImageUrl: URL + "net/imageUp.ashx"           //word转存提交地址
        , wordImagePath: window.DEFINITION_URL               
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处编辑，需要在后台对应文件编辑对应参数
        ...
        , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl', 'music', 'attachment', 'map', 'gmap', 'insertframe', 'highlightcode', 'pagebreak', 'template', 'background', '|',
