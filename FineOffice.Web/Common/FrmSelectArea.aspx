<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmSelectArea.aspx.cs" Inherits="Common_FrmSelectArea" %>
...
<body>
    <form id="_FrmSelectArea" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" ShowBorder="false" Layout="Fit" BoxConfigAlign="Stretch"
        ...
        <Items>
            <x:Tree runat="server" ID="tvwArea" AutoScroll="true" EnableIcons="false" Expanded="true"
                Title="地区信息" ShowHeader="false" ShowBorder="false">
            </x:Tree>
        </Items>
    </x:Panel>
    </form>
