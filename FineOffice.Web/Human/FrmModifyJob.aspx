<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmModifyJob.aspx.cs" Inherits="Human_FrmNewJob" %>
...
<body>
    <form id="_FrmModifyJob" runat="server">
        ...
        <Toolbars>
            <x:Toolbar ID="tsMain" runat="server">
                <Items>
                    ...
                    <x:Button ID="btnSave" Text="保存" runat="server" Icon="SystemSaveNew" ValidateForms="frmJob"
