<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmShareHardDisk.aspx.cs"
    Inherits="HardDisk_FrmShareHardDisk" %>
...
<body>
    <form id="_FrmShareHardDisk" runat="server">
                                    ...
                                    <x:Toolbar ID="tsbMain" runat="server">
                                        <Items>
                                            ...
                                            <x:Button ID="btnMoveFile" Icon="PageWhiteGo" OnClick="btnMoveFile_Click" Text="移动文件"
                                                runat="server" />
                                            <x:Button ID="btnCopyToPerson" Icon="UserGo" EnablePostBack="false" Text="复制到职员"
                                                OnClick="btnCopyToPerson_Click" runat="server" />
                                            <x:ToolbarSeparator runat="server" />
    ...
    <uc1:WebPageAuthority ID="pageAuthority" PageAuthority='["btnNewFolder","btnModifyFolder","btnDeleteFolder","btnMoveFolder","btnUpload","btnModifyFile","btnMoveFile","btnDeleteFile","btnDownFile","btnCopyToPerson"]'
        runat="server" />
    </form>
