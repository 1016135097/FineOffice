<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmModifyFlow.aspx.cs" Inherits="WorkFlow_FrmNewForm" %>
                    ...
                    <x:SimpleForm ID="frmFlow" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                        ...
                        <Items>
                            ...
                            <x:GroupPanel runat="server" AutoHeight="true" Title="流程选项" ID="grpOption" Width="544">
                                <Items>
                                    <x:Form ID="Form1" runat="server" ShowBorder="False" EnableBackgroundColor="true"
                                        ShowHeader="False">
                                        <Rows>
                                            <x:FormRow runat="server">
                                                <Items>
                                                    <x:CheckBox ID="chkAllowRecall" runat="server" Checked="true" Label="允许召回" />
                                                    <x:CheckBox ID="chkAllowRevoke" runat="server" Checked="true" Label="允许撤消" />
                                                </Items>
                                            </x:FormRow>
                                            <x:FormRow runat="server">
                                                <Items>
