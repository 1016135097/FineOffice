<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmLetterChannel.aspx.cs"
    Inherits="Letter_FrmLetterChannel" %>
...
<body>
    <form id="_FrmLetterChannel" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <x:Panel ID="pnlLetterChannel" ShowBorder="True" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Toolbars>
                ...
                <Items>
                    <x:Grid ID="letterChannelGird" ShowBorder="false" ShowHeader="False" runat="server"
                        EnableCheckBoxSelect="True" DataKeyNames="ID,Channel" EnableRowNumber="True"
                        Title="信访渠道" OnRowCommand="letterChannelGird_RowCommand">
                        <Columns>
                            <x:BoundField Width="100px" ColumnID="Channel" SortField="Channel" DataField="Channel"
                                HeaderText="信访渠道" />
                            <x:WindowField TextAlign="Center" Width="60px" WindowID="winModifyLetterChannel"
                                Icon="Pencil" ColumnID="btnModify" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="frmmodifyletterchannel.aspx?ID={0}"
                                Hideable="false" DataWindowTitleFormatString="编辑-{0}" DataWindowTitleField="Channel" />
    ...
    <x:Window ID="wndNewLetterChannel" Title="新增" Popup="false" EnableMaximize="false"
        IsModal="true" Target="Parent" EnableResize="false" runat="server" Icon="Add"
        Width="420px" Height="120px" EnableConfirmOnClose="true" EnableIFrame="true"
        IFrameUrl="FrmNewLetterChannel.aspx">
    </x:Window>
    <x:Window ID="wndModifyLetterChannel" Title="编辑" Popup="false" EnableMaximize="false"
