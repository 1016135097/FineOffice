<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmLetterType.aspx.cs" Inherits="Letter_FrmLetterType" %>
...
<body>
    <form id="_FrmLetterType" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <x:Panel ID="pnlLetterType" ShowBorder="True" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Toolbars>
                ...
                <Items>
                    <x:Grid ID="letterTypeGird" Title="问题分类" ShowBorder="false" ShowHeader="False" runat="server"
                        EnableCheckBoxSelect="True" DataKeyNames="ID,Channel" EnableRowNumber="True"
                        OnRowCommand="letterTypeGird_RowCommand">
                        <Columns>
                            <x:BoundField Width="100px" ColumnID="LetterType" SortField="LetterType" DataField="LetterType"
                                HeaderText="问题分类" />
                            <x:WindowField TextAlign="Center" Width="60px" WindowID="wndModifyLetterType" Icon="Pencil"
                                ColumnID="btnModify" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="frmmodifylettertype.aspx?ID={0}"
                                Hideable="false" DataWindowTitleFormatString="编辑-{0}" DataWindowTitleField="LetterType" />
    ...
    <x:Window ID="wndNewLetterType" Title="新增" Popup="false" EnableMaximize="false" IsModal="true"
        Target="Parent" EnableResize="false" runat="server" Icon="Add" Width="420px"
        Height="120px" EnableConfirmOnClose="true" EnableIFrame="true" IFrameUrl="FrmNewLetterType.aspx">
    </x:Window>
    <x:Window ID="wndModifyLetterType" Title="编辑" Popup="false" EnableMaximize="false"
