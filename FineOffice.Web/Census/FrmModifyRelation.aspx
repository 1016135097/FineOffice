<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmModifyRelation.aspx.cs"
    Inherits="Census_FrmModifyRelation" %>
...
<body>
    <form id="_FrmModifyRelation" runat="server">
        ...
        <Items>
            <x:SimpleForm ID="simpleForm" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="False"
                ...
                <Items>
                    ...
                    <x:TextBox ID="txtRelation" ShowLabel="false" Required="true" runat="server" />
                </Items>
            </x:SimpleForm>
        </Items>
        <Toolbars>
