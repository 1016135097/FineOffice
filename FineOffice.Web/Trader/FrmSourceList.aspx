<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmSourceList.aspx.cs" Inherits="Trader_FrmSourceList" %>
...
<body>
    <form id="_FrmSourceList" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <x:Panel ID="pnlSourceList" ShowBorder="True" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Toolbars>
                ...
                <Items>
                    <x:Grid ID="sourceGrid" Title="来源渠道" ShowBorder="false" ShowHeader="False" runat="server"
                        EnableCheckBoxSelect="True" DataKeyNames="ID,Source" EnableRowNumber="True" OnRowCommand="sourceGrid_RowCommand">
                        <Columns>
                            ...
                            <x:BoundField Width="200px" ColumnID="Remark" SortField="Remark" DataField="Remark"
                                HeaderText="备注" />
                            <x:WindowField TextAlign="Center" Width="60px" WindowID="modifySourceWin" Icon="Pencil"
                                ToolTip="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="FrmModifySource.aspx?ID={0}"
    ...
    <x:Window ID="newSourceWin" Title="新增" Popup="false" EnableMaximize="false" IsModal="true"
        Target="Parent" EnableResize="false" runat="server" Icon="Add" Width="500px"
        Height="300px" EnableConfirmOnClose="true" EnableIFrame="true" IFrameUrl="FrmNewSource.aspx">
    </x:Window>
    <x:Window ID="modifySourceWin" Title="编辑" Popup="false" EnableMaximize="false" IsModal="true"
