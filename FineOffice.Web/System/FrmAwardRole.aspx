<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmAwardRole.aspx.cs" Inherits="System_FrmAwardRole" %>
...
<body>
    <form id="_FrmAwardRole" runat="server">
                ...
                <Items>
                    <x:SimpleForm ID="frmUser" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                        ...
                        <Items>
                            ...
                            <x:CheckBoxList ID="chkRole" runat="server" ColumnNumber="2" Label="系统角色" />
                        </Items>
                    </x:SimpleForm>
                </Items>
            </x:Panel>
