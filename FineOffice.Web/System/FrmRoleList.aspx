<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmRoleList.aspx.cs" Inherits="System_FrmRoleList" %>
...
<body>
    <form id="_FrmRoleList" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <x:Panel ID="pnlRolebGrid" ShowBorder="True" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Toolbars>
                ...
                <Items>
                    <x:Grid ID="rolebGrid" Title="角色" PageSize="20" ShowBorder="false" AllowPaging="true"
                        OnPageIndexChange="rolebGrid_PageIndexChange" ShowHeader="False" runat="server"
                        SortColumn="Ordering" EnableCheckBoxSelect="True" DataKeyNames="ID,RoleName,IsModify"
                        SortDirection="ASC" EnableRowNumber="True" OnRowCommand="rolebGrid_RowCommand">
                        <Columns>
                            <x:BoundField Width="100px" ColumnID="RoleName" SortField="RoleName" DataField="RoleName"
                                HeaderText="角色名称" />
                            ...
                            <x:WindowField TextAlign="Center" Width="60px" WindowID="modifyRoleWin" Icon="Pencil"
                                ColumnID="btnModify" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="FrmModifyRole.aspx?id={0}"
                                Hideable="false" DataWindowTitleField="RoleName" DataWindowTitleFormatString="编辑-{0}" />
    ...
    <x:Window ID="newRoleWin" Title="新增" Popup="false" EnableMaximize="false" IsModal="true"
        Target="Parent" EnableResize="false" runat="server" Icon="Add" Width="500px"
        Height="300px" EnableConfirmOnClose="true" EnableIFrame="true" IFrameUrl="FrmNewRole.aspx">
    </x:Window>
    <x:Window ID="modifyRoleWin" Title="编辑" Popup="false" EnableMaximize="true" IsModal="false"
