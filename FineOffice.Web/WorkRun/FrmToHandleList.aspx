<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmToHandleList.aspx.cs"
    Inherits="WorkRun_FrmToHandleList" %>
...
<body>
    <form id="_FrmToHandleList" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <x:Panel ID="pnlWorkGrid" ShowBorder="true" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Toolbars>
                ...
                <Items>
                    <x:Grid ID="workGrid" Title="待办工作" DataKeyNames="ID,WorkName,ProcessName" PageSize="20"
                        ...
                        <Columns>
                            ...
                            <x:BoundField Width="100px" ColumnID="FlowSortName" SortField="FlowSortName" DataField="FlowSortName"
                                HeaderText="流程分类" />
                            <x:BoundField Width="100px" ColumnID="PatternName" SortField="PatternName" DataField="PatternName"
                                HeaderText="原因" />
                            ...
                            <x:WindowField TextAlign="Center" WindowID="frmRunTransmit" Width="60px" Icon="UserGo"
                                Hideable="false" ToolTip="工作委托" DataIFrameUrlFormatString="FrmFlowRunTransmit.aspx?ID={0}"
                                DataIFrameUrlFields="ID" DataWindowTitleFormatString="工作委托-{0}" DataWindowTitleField="ProcessName" />
                            <x:LinkButtonField TextAlign="Center" Icon="PageWhiteEdit" CommandName="handle" Width="60px"
                                ToolTip="工作办理" Hideable="false" />
                        </Columns>
                    </x:Grid>
                </Items>
            </x:Panel>
