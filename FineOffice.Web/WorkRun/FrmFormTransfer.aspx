<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmFormTransfer.aspx.cs"
    Inherits="WorkRun_FrmFormTransfer" %>
...
<body>
    <form id="_FrmFormTransfer" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <x:Panel ID="pnlWorkForm" ShowBorder="true" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Toolbars>
                ...
                <Items>
                    <x:Grid ID="workFormGrid" DataKeyNames="ID,WorkName,ProcessName" PageSize="20" IsDatabasePaging="true"
                        OnRowCommand="workFormGrid_RowCommand" ShowBorder="false" AllowPaging="true"
                        Title="表单" AllowSorting="true" OnPageIndexChange="workFormGrid_PageIndexChange"
                        ShowHeader="False" EnableMultiSelect="false" runat="server" EnableCheckBoxSelect="True"
                        SortColumn="CreateTime" SortDirection="ASC" OnSort="workFormGrid_Sort" EnableRowNumber="True">
                        <Columns>
                            ...
                            <x:BoundField Width="100px" ColumnID="FlowSortName" SortField="FlowSortName" DataField="FlowSortName"
                                HeaderText="流程分类" />
                            <x:LinkButtonField TextAlign="Center" ColumnID="btnDelete" Icon="Delete" ConfirmText="确认删除吗？"
    ...
    <uc1:WebPageAuthority ID="pageAuthority" PageAuthority='["btnTransfer","btnDownForm","btnDelete"]'
        runat="server" />
    </form>
</body>
</html>
