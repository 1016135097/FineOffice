<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmFlowRunEvent.aspx.cs"
    Inherits="WorkRun_FrmFlowRunEvent" %>
...
<body>
    <form id="_FrmFlowRunEvent" runat="server">
    ...
    <x:Panel ID="pnlMain" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false"
        ...
        <Items>
            <x:Grid ID="transmitGrid" ShowHeader="False" ShowBorder="true" runat="server" DataKeyNames="ID"
                OnRowDataBound="Grid_RowDataBound" EnableMultiSelect="false" EnableRowNumber="false"
                AllowSorting="true" OnSort="Grid_Sort" SortColumn="acceptTime">
                <Columns>
                    ...
                    <x:BoundField Width="100px"   HeaderText="下一步骤" ColumnID="transmitTo"
                        DataField="TransmitTo" SortField="TransmitTo" />
