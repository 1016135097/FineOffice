...
{
    public class OA_FlowForm : BaseDataAccess<FineOffice.Entity.OA_FlowForm>, FineOffice.IDataAccess.OA_FlowForm
    {
        public List<Modules.OA_FlowForm> GetList(Modules.Helper.ChangeTrackingList<Modules.Helper.EntitySearcher> changeTrackingList)
        {
            ...
            strSql.Append("FROM vw_oa_flowform WHERE 1=1 ");
            ...
            List<Modules.OA_FlowForm> list = new List<Modules.OA_FlowForm>();
            try
            {
                DataTable dt = DbHelperSQL.Query(strSql.ToString()).Tables[0];
                list = FineOffice.Common.CollectionHelper.ConvertTo<FineOffice.Modules.OA_FlowForm>(dt) as List<FineOffice.Modules.OA_FlowForm>;
            }
            catch (Exception ex)
            {
        ...
        public int GetCount(Modules.Helper.ChangeTrackingList<Modules.Helper.EntitySearcher> changeTrackingList)
        {
            ...
            str.Append("FROM vw_oa_flowform WHERE 1=1 ");
            int count = 0;
